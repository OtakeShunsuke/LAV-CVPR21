...
CONFIG.ROOT = '/root/src/dataset/Penn_Action/root'
CONFIG.CKPT_PATH = '/root/src/dataset/Penn_Action/checkpoints'
CONFIG.DATA_PATH = '/root/src/dataset/Penn_Action/data/squat'
CONFIG.GPUS = 1
CONFIG.SEED = 0
